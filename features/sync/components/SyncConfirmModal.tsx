...
export const SyncConfirmModal: React.FC<SyncConfirmModalProps> = ({ isOpen, onConfirm, onCancel }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-[110] p-4 animate-in fade-in">
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 max-w-md w-full shadow-2xl border border-white/20 animate-in zoom-in-95 duration-300">
                <div className="flex flex-col items-center text-center">
                    ...
                    <h3 className="text-2xl font-black text-slate-800 dark:text-slate-100 mb-2">{t.settings.sync.title}</h3>
                    <p className="text-slate-500 dark:text-slate-400 font-medium mb-8 leading-relaxed">
                        {t.settings.sync.confirmReplace}
                    </p>
